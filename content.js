...
async function preview() {
    ...
    notification.forEach(notification => {
        if (notifications[index].template == "template_13"){//엔트리 이야기 또는 노팁, 묻답 등 커뮤니티과 관련된 내용
        ...
        } else if (notifications[index].template == "template_28") {//새로운 작품과 관련된 내용
        ...
        } else if (notifications[index].template == "template_27") {//팔로잉과 관련된 내용
        ...
        } else if (notifications[index].template == "template_3") {//좋아요와 관련된 내용
